...
- **Mercado objetivo y fuente de precios:** **Colombia**, con **DANE SIPSA** (Sistema de Información de Precios y Abastecimiento del Sector Agropecuario) como fuente de precios reales — es información pública, gratuita, sin necesidad de cuenta/API key. Limitación conocida y aceptada: SIPSA reporta precio mayorista agropecuario (central de abastos), no precio de góndola por SKU comercial empacado — habrá que definir un factor de conversión o simplemente documentar que el precio es mayorista, no de supermercado, cuando se implemente. La integración en sí (reemplazar `set_placeholder_prices.py` por un import real desde SIPSA) sigue pendiente, ver [03-tasks.md](03-tasks.md).
